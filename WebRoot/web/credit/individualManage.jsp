...
<div class="pageContent">
	...
	<div class="panelBar">
		...
		<div class="pagination" target="navTab" id="indicount" totalCount="<%=request.getAttribute("totalRows") %>" numPerPage="20" pageNumShown="10" currentPage="<%=request.getAttribute("currentPage")%>"></div>
	</div>
</div>