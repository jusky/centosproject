...
<script type="text/javascript">
	...
	function onClick(e, treeId, treeNode) {
		var zTree = $.fn.zTree.getZTreeObj("editMistypeTree"),
	...
	$(function(){  
	    ...
	    $.fn.zTree.init($("#editMistypeTree"), setting, treeNodes);
	});
</script> 
<div class="pageContent">
	<form method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);" action="<%=path%>/configMistypeAction.do?method=save&operation=edit">
		<logic:notEmpty name="configMistypeForm" property="recordList">
     	<logic:iterate name="configMistypeForm" property="recordList" id="MistypeBean">
...
<div id="menuContent" class="menuContent" style="display:none; border:solid 1px #CCC; background:#fff; position: absolute;">
	<ul id="editMistypeTree" class="ztree" style="margin-top:0; width:240px;"></ul>
</div>