...
<logic:notEqual value="true" name="deptFKForm" property="recordNotFind">
 <logic:notEmpty name="deptFKForm" property="recordList">
  <logic:iterate name="deptFKForm" property="recordList" id="DeptDCBean">
	<div class="panel">
			...
			<dl class="nowrap">
				...
				<logic:notEqual value="" name="DeptDCBean" property="status">
					<logic:equal value="1" name="DeptDCBean" property="isSubmit">						
						<a href="<%=path%>/deptFKAction.do?method=onlineSubmit&id=${DeptDCBean.id }&reportID=${DeptDCBean.reportID }&adviceID=${DeptDCBean.adviceID }" target="navTab" rel="onlineSubmit"><font color="red">查看已提交调查结果</font></a>
					</logic:equal>
					<logic:equal value="0" name="DeptDCBean" property="isSubmit">
						<a href="<%=path%>/deptFKAction.do?method=onlineSubmit&id=${DeptDCBean.id }&reportID=${DeptDCBean.reportID }&adviceID=${DeptDCBean.adviceID }" target="navTab" rel="onlineSubmit"><font color="red">在线提交调查结果</font></a>					
					</logic:equal>
				</logic:notEqual>
				</dd>
			</dl>
	...
	<logic:equal value="true" name="deptFKForm" property="recordNotFind">
