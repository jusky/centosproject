	...
	<head>
		...
		<script type="text/javascript">
			...
			*/
             var word = new word();
             //决定路径
		     word.setUploadUrl("http://127.0.0.1/word/upload_handle.jsp");
		     ...
		     function load(){
		         ...
		         word.openDoc('1.doc',"http://127.0.0.1/word/upload/1.doc");
		         //setFileVal();
		     }
		     //
		     function unload(){
		     ...
		     function setFileVal(){
		     	document.getElementById('oframe').SetFieldValue("test","2006-03-16 22:22:22","");
		     }
