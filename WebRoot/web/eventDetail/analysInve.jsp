	...
	<div class="accordion" style="width:99%;">
		<logic:notEqual value="true" name="eventDetailForm" property="recordNotFind">
			<logic:notEmpty name="eventDetailForm" property="recordList">
	     		<logic:iterate name="eventDetailForm" property="recordList" id="AnalysandInve">
				<div class="accordionHeader">
					<h2>办公人员：<font color="#ff0000">${AnalysandInve.workername }</font>，时间：${AnalysandInve.time }</h2>
				</div>
				<div class="accordionContent" style="height:<%=height %>">
					<br/>
					<h2>分析结论：</h2>
					<p style="line-height:20px;">${AnalysandInve.content }</p>
					<br/>
					<br/>
					<h2>下载附件：</h2>
					<p style="line-height:20px;">
						<logic:notEqual value="" name="AnalysandInve" property="attachname">
							<a href="${AnalysandInve.attachname }"><font color="blue">下载</font></a>
						</logic:notEqual>
						<logic:equal value="" name="AnalysandInve" property="attachname">
							无
						</logic:equal>
					</p>
				</div>
