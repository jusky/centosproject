...
<script src="${ctx}/dwz/js/jquery-1.7.1.js" type="text/javascript"></script>
...
<script src="${ctx}/dwz/xheditor/xheditor-1.1.12-zh-cn.min.js" type="text/javascript"></script>
<script src="${ctx}/dwz/uploadify/scripts/swfobject.js" type="text/javascript"></script>
<script src="${ctx}/dwz/uploadify/scripts/jquery.uploadify.v2.1.0.js" type="text/javascript"></script>
